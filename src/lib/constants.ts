...
export const UI_LABELS = {
  ...
  loan: {
    ...
    totalBorrowing: "Tổng nợ",
    totalLending: "Tổng cho vay",
    netDebt: "Nợ ròng",
    counterparty: "Đối tác",
    addLoan: "Thêm khoản vay",
    confirmPaid: "Xác nhận đã thanh toán khoản này?",
  },
  dashboard: {
    ...
    healthScore: "Sức khỏe tài chính",
    spendingTrend: "Xu hướng chi tiêu",
    categoryBreakdown: "Phân bổ chi tiêu",
    ...
    allTime: "Tất cả",
    viewAll: "Xem tất cả",
    excludeBigItems: "Không tính khoản lớn",
  },
  common: {
    save: "Lưu",
    cancel: "Hủy",
